...
const Home = () => {
    ...
    const createProject = async (e) => {
        ...
        try {
            ...
            if (newProject) {
                // Since the backend now returns just the project object, we use it directly
            ...
            const errorMessage = error.response?.data?.message || 'Could not create the project. Please try again.';
    ...
    const updateProject = async (e) => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.message || 'Could not update the project. Please try again.';
            showMessage(errorMessage, 'error');
        }
    };
    ...
    const deleteProject = async () => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.message || 'Could not delete the project. Please try again.';
            showMessage(errorMessage, 'error');
        }
    };
    ...
    const handleProjectClick = (project) => {
        // Correct way to navigate with projectId in the URL
    ...
    return (
        <main className="min-h-screen bg-gray-900 text-gray-100 p-4 md:p-8 font-inter">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6 md:mb-10">
                    <h1 className="text-3xl md:text-4xl font-extrabold text-blue-400 mb-4 md:mb-0">Your Projects</h1>
                    {/* Logout Button */}
                    <button
                        onClick={handleLogout}
                        className="px-4 py-2 md:px-6 md:py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-300
                ...
                <div className={`grid ${gridClass} gap-4 md:gap-8`}>
                    ...
                    <button
                        ...
                        className="flex flex-col items-center justify-center p-6 md:p-8 border-2 border-dashed border-blue-600 rounded-2xl
                                   text-blue-400 hover:bg-blue-900/20 transition-all duration-300 cursor-pointer
                                   min-h-[180px] shadow-lg hover:shadow-xl group
                                   focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                    >
                        <i className="ri-add-line text-4xl md:text-5xl mb-3 group-hover:scale-110 transition-transform"></i>
                        <span className="text-lg md:text-xl font-semibold">New Project</span>
                    </button>
                    ...
                    {projects.map((project) => (
                        <div
                            key={project._id}
                            className="relative flex flex-col justify-between p-6 md:p-7 bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl
                                       transition-all duration-300 border border-gray-700 hover:border-blue-600 min-h-[180px]"
                        >
                            {/* Project Info - Clickable area */}
                            <div
                                onClick={() => handleProjectClick(project)} // Corrected onClick handler
                                className="cursor-pointer flex-grow pb-4"
                            >
                                <h2 className="text-xl md:text-2xl font-bold mb-2 text-blue-300">{project.name}</h2>
                ...
                {isCreateModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-40 p-4">
                        <div className="bg-gray-800 p-6 md:p-10 rounded-xl shadow-2xl w-full max-w-md border border-gray-700">
                            <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-blue-300 text-center">Create New Project</h2>
                            <form onSubmit={createProject}>
                                ...
                                <div className="flex justify-end space-x-2 md:space-x-4">
                                    <button
                                        type="button"
                                        className="px-4 py-2 md:px-6 md:py-3 bg-gray-700 text-gray-300 rounded-lg hover:bg-gray-600 transition-colors duration-300
                                    ...
                                    <button
                                        type="submit"
                                        className="px-4 py-2 md:px-6 md:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-300
                                                   focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                                    >
                                        Create
                                    </button>
                ...
                {isEditModalOpen && projectToEdit && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-40 p-4">
                        <div className="bg-gray-800 p-6 md:p-10 rounded-xl shadow-2xl w-full max-w-md border border-gray-700">
                            <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-blue-300 text-center">Edit Project</h2>
                ...
                {isConfirmDeleteModalOpen && projectToDelete && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-40 p-4">
                        <div className="bg-gray-800 p-6 md:p-10 rounded-xl shadow-2xl w-full max-w-sm text-center border border-gray-700">
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 text-red-400">Confirm Deletion</h2>
                            ...
                            <div className="flex justify-center space-x-2 md:space-x-4">
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2 md:px-6 md:py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-300
                                                   focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-gray-900"
