...
const Project = () => {
    ...
    const [isMobileChatOpen, setIsMobileChatOpen] = useState(false); // NEW: State for mobile chat sidebar
    const [isMobileExplorerOpen, setIsMobileExplorerOpen] = useState(false); // NEW: State for mobile explorer sidebar
    ...
    useEffect(() => {
        const loadProject = async () => {
            ...
            if (!currentProject && urlProjectId) {
                try {
                    const res = await axios.get(`/projects/${urlProjectId}`);
    ...
    const runProject = useCallback(async () => {
        ...
        // This is not in the current code you provided, but it's a good practice
    ...
    }, [webContainer, isWebContainerReady, fileTree, runProcess]);
